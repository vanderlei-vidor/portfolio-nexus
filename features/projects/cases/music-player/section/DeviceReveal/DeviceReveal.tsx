...
export default function DeviceReveal() {
  ...
  // ✅ CORREÇÃO: Gerar posições aleatórias apenas no cliente
  ...
  // ✅ Gerar partículas apenas no cliente (evita hydration mismatch)
  useEffect(() => {
    setParticles(
  ...
  return (
    <section ref={sectionRef} className="relative flex min-h-screen items-center overflow-hidden bg-black px-6 py-32">
      ...
      {/* Ambient Glow */}
      <div className="absolute left-1/2 top-1/2 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-br from-blue-500/10 via-purple-500/5 to-cyan-500/5 blur-[200px]" />
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-20 lg:grid-cols-2">
        ...
        <div className="relative flex items-center justify-center perspective-[2000px]">
          ...
          <div className="absolute h-[600px] w-[600px] rounded-full bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-cyan-500/10 blur-[150px] animate-pulse duration-[4000ms]" />

          {/* Device Container */}
          <motion.div
            ref={deviceRef}
            className="relative w-[260px] transform-gpu transition-transform duration-700 hover:rotate-0"
            style={{
              rotateX,
              rotateY,
          ...
          >
              ...
              <div className="relative aspect-[394/839] w-full rounded-[2.8rem] bg-zinc-900 overflow-hidden flex flex-col justify-between p-6">
                ...
                <div className="flex flex-col items-center gap-6 z-10 justify-center flex-1">
                  ...
                  >
                    ...
                    />
                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center border border-white/20 shadow-lg shadow-blue-500/20">
                      <motion.div
            ...
            {/* ✅ CORREÇÃO: Partículas com posições geradas no cliente */}
